...
const metasprite_t ship_up1[] = {
    METASPR_ITEM(0, 0, 4, 0), METASPR_ITEM(0, 8, 6, 0),
    METASPR_TERM
};

const metasprite_t ship_up2[] = {
    METASPR_ITEM(0, 0, 8, 0), METASPR_ITEM(0, 8, 10, 0),
    METASPR_TERM
};

const metasprite_t ship_up3[] = {
    METASPR_ITEM(0, 0, 12, 0), METASPR_ITEM(0, 8, 14, 0),
    METASPR_TERM
};

const metasprite_t ship_up4[] = {
    METASPR_ITEM(0, 0, 16, 0), METASPR_ITEM(0, 8, 18, 0),
    METASPR_TERM
};
